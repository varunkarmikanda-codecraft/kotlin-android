...
fun makeDecoration() {
    ...
    Log.i("DATA CLASS", "$decoration1")

    val decoration2 = Decoration("Slate")
    Log.i("DATA CLASS", "$decoration2")

    val decoration3 = Decoration("Slate")
    Log.i("DATA CLASS", "$decoration3")

    Log.i("DATA CLASS", "${decoration2 == decoration3}")
    Log.i("DATA CLASS", "${decoration2 === decoration3}")

    val decoration4 = Decor2("rocks", "wood", "diver");
    Log.i("DATA CLASS", "$decoration4")

    val(rocks, wood, diver) = decoration4
    Log.i("DATA CLASS", "$rocks\n$wood\n$diver")
